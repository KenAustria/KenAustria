// filename: Method-Parameters-Dynamic.js
...
const MyChildProcessor = props => {
  ...
  let mySum =
    ...
    parseInt(props.myNumbersObjectProps.myNum2, 10); // above: add the numbers.
  return (
    <div>
      ...
      <div>
        ...
        {props.myNumbersObjectProps.myNum2} = {mySum}
      </div>
    </div>
  );
};
class MyParent extends Component {
  ...
  //-----------------------------------------------------------------------------------
  myInputText = event => {
    // temporary place the new numbers inside an object literal.
