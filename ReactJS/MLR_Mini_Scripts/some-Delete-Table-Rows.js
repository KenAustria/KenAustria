// filename: Set-Delete-Table-Rows.js (using the Set() method).
...
class MyTable extends Component {
  ...
  state = {
    myTableData: [
      { myId: "0x", myName: "John", myCheckboxStatus: false },
      { myId: "1x", myName: "Randal", myCheckboxStatus: false },
      { myId: "2x", myName: "Stephanie", myCheckboxStatus: false },
      { myId: "3x", myName: "Joyce", myCheckboxStatus: false },
      { myId: "4x", myName: "Adam", myCheckboxStatus: false }
    ]
  };
