...
def my_rotate!(array, amt)
  if amt > 0 # case, amt is positive
    amt.times do # execute as many as amt input
      el = array.shift # remove 1st element of array
      array << el # add to end of array
    end
  else
    (-amt).times do # case, amt is negative, flip to positive with () syntax
      el = array.pop # remove last index
      array.unshift(el) # insiert to first index
    end
  end
