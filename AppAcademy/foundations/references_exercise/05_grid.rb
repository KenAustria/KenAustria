...
def grid(n, m)
  Array.new(n) { Array.new(m) } # outermost array has n elements, each with subarray of m length
  # wrapped in block allows for multiple executions
  # will make each subarray distinct in memory
end
