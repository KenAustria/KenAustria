...
def swapper(arr, idx_1, idx_2)
  # syntax hack for swapping adjacent element's values
  # arr[idx_1] = arr[idx_2]
  # arr[idx_2] = arr[idx_1]
  # arr[idx_1], arr[idx_2] = arr[idx_2], arr[idx_1]
  arr[idx_2], arr[idx_1] = arr[idx_1], arr[idx_2] 
  # works either way, just align reassignment
  # first to left of equal sign is defined with first to right of equal sign
  arr
end
