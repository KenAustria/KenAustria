...
def adult_in_group?(people)
  # are there any elements that return true for the given condition
  #  When getting a value from the hash after initialization,
  # we must always put the colon on the left like normal. hash[:key] is the correct syntax.
